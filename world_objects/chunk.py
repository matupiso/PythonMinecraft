...
class Chunk:
    def __init__(self, world, position):
        ...
        x,y, z = position
        self.light_map = world.light_map[get_chunk_index((x * CHUNK_SIZE, y * CHUNK_SIZE, z * CHUNK_SIZE))]
    ...
    def set_uniform(self):
        ...
        self.mesh.program['sun_light'].write(glm.vec3(self.app.scene.sun.light))
    ...
    def render(self):
        if not self.is_empty and self.is_on_frustom() and self.is_active:
            self.set_uniform()
            self.mesh.render()
