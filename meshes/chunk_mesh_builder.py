...
from utils import can_bcm_block
...
@njit
def to_uint8(x, y, z, voxel_id, face_id, ao_id, light_id):
    return uint8(x),uint8(y),uint8(z),uint8(voxel_id),uint8(face_id),uint8(ao_id),uint8(light_id)
...
@njit
def is_void(voxel_pos, world_pos, world_voxels):
    chunk_index = get_chunk_index(world_pos)
    if chunk_index == -1:
        return True
    ...
    if not chunk_voxels[voxel_index] in [0, TORCH]:
        return False
...
@njit
def build_chunk_mesh(chunk_voxels, format_size, chunk_position, world_voxels, light_map):
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if not voxel_id or voxel_id in [TORCH, ]: continue
                #voxel world pos
                ...
                if is_void((x, y + 1, z), (wx, wy + 1, wz), world_voxels):
                    ...
                    v0 = to_uint8(x    , y + 1, z    , voxel_id, 0, ao[3], light_id)
                    v1 = to_uint8(x + 1, y + 1, z    , voxel_id, 0, ao[0], light_id)
                    v2 = to_uint8(x + 1, y + 1, z + 1, voxel_id, 0, ao[1], light_id)
                    v3 = to_uint8(x    , y + 1, z + 1, voxel_id, 0, ao[2], light_id)
                ...
                if is_void((x, y - 1, z), (wx, wy - 1, wz), world_voxels):
                    ...
                    v0 = to_uint8(x    , y, z    , voxel_id, 1, ao[3], light_id)
                    v1 = to_uint8(x + 1, y, z    , voxel_id, 1, ao[0], light_id)
                    v2 = to_uint8(x + 1, y, z + 1, voxel_id, 1, ao[1], light_id)
                    v3 = to_uint8(x    , y, z + 1, voxel_id, 1, ao[2], light_id)
                ...
                if is_void((x + 1, y, z), (wx + 1, wy, wz), world_voxels):
                    ...
                    v0 = to_uint8(x + 1, y    , z    , voxel_id, 2, ao[2], light_id)
                    v1 = to_uint8(x + 1, y + 1, z    , voxel_id, 2, ao[3], light_id)
                    v2 = to_uint8(x + 1, y + 1, z + 1, voxel_id, 2, ao[0], light_id)
                    v3 = to_uint8(x + 1, y    , z + 1, voxel_id, 2, ao[1], light_id)
                ...
                if is_void((x - 1, y, z), (wx - 1, wy, wz), world_voxels):
                    ...
                    v0 =  to_uint8(x, y    , z    , voxel_id, 3, ao[2], light_id)
                    v1 =  to_uint8(x, y + 1, z    , voxel_id, 3, ao[3], light_id)
                    v2 =  to_uint8(x, y + 1, z + 1, voxel_id, 3, ao[0], light_id)
                    v3 =  to_uint8(x, y    , z + 1, voxel_id, 3, ao[1], light_id)
                ...
                if is_void((x, y, z - 1), (wx, wy, wz - 1), world_voxels):
                    ...
                    v0 = to_uint8(x,     y,     z, voxel_id, 4, ao[2], light_id)
                    v1 = to_uint8(x,     y + 1, z, voxel_id, 4, ao[3], light_id)
                    v2 = to_uint8(x + 1, y + 1, z, voxel_id, 4, ao[0], light_id)
                    v3 = to_uint8(x + 1, y,     z, voxel_id, 4, ao[1], light_id)
                ...
                if is_void((x, y, z + 1), (wx, wy, wz + 1), world_voxels):
                    ...
                    v0 = to_uint8(x    , y    , z + 1, voxel_id, 5, ao[2], light_id)
                    v1 = to_uint8(x    , y + 1, z + 1, voxel_id, 5, ao[3], light_id)
                    v2 = to_uint8(x + 1, y + 1, z + 1, voxel_id, 5, ao[0], light_id)
                    v3 = to_uint8(x + 1, y    , z + 1, voxel_id, 5, ao[1], light_id)
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if not voxel_id or not voxel_id  in [TORCH]: continue   
